...
parser.add_argument('-p','--press',dest='pressure',type=int,help='pressure in GPa',required=True)
...
compressibility_a = 1e-5 # water compressibility at normal conditions = 4.57e-5 
